    ...
    fetch("http://localhost:8080/api/user/login", {
      ...
      .then(res => {
        ...
        if (res.success && res.jwtToken) {
          ...
          toast.error(res.responseMessage || "Invalid credentials. Please try again.", {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: "radial-gradient(circle, rgba(45,127,255,0.06) 0%, transparent 65%)",
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          <div style={{
            ...
            display: "flex", alignItems: "center", justifyContent: "center",
            margin: "0 auto 18px",
            boxShadow: "0 10px 40px rgba(45,127,255,0.45)",
          ...
          <p style={{ color: "var(--text-secondary)", fontSize: "0.9rem" }}>
            Sign in to your SkyLine account
          </p>
        </div>
        ...
        <div className="glass-card" style={{ padding: "36px" }}>
          ...
          <p style={{ textAlign: "center", color: "var(--text-secondary)", fontSize: "0.875rem" }}>
            ...
            <Link to="/user/passenger/register" style={{ color: "var(--accent-blue-bright)", fontWeight: 600 }}>
              Register here
            </Link>
          </p>
        </div>
